...
│   └── tab_alpha_tracker.py    # Tab 6: Signal Audit & Post-Market Alpha Tracker Dashboard
│
...
│                               # - Direct Message (DM) private alerts for urgent risk triggers
...
│   ├── conftest.py             # Pytest configuration and offline fixtures
...
flowchart TD
    ...
    subgraph UI ["5. Streamlit User Interface"]
        ...
        AppCore --> Tab6["Tab 6: Alpha Tracker Audit"]
        Tab6 -->|Query Win Rate, Profit Factor, Alpha| DBManager
    end
    ...
    subgraph Alerts ["6. Notification Delivery"]
        ...
        Discord --> DiscordDM["Discord Private DM"]
    end
```

---

## 3. 🛡️ Institutional Signal Credibility Engine Specifications

The system implements strict anti-dilution risk controls designed to solve retail alert spam:
...
| **Anti-Chasing Filter** | Ceiling Check (+6.85%) | `data_engine.py` + `tests/test_alpha_and_lifecycle.py` | Automatically vetoes buy orders when price is pinned at HOSE upper trading limit. |
